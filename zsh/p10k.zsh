# Generated by Powerlevel10k configuration wizard on 2026-02-08 at 00:03 CET.
...
() {
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$P10K_COLOR_PINK66
  ...
  # typeset -g POWERLEVEL9K_EXAMPLE_FOREGROUND=$P10K_COLOR_PINK208
